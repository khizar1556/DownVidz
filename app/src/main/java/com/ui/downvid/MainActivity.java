...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView downImgViw,searchImgViw;
...
int i=getSupportFragmentManager().getBackStackEntryCount();
        if (getSupportFragmentManager().getBackStackEntryCount() == 2 && getIntent().getBooleanExtra("flagsearch",false) ) {
            finish();
        } else if(getIntent().getBooleanExtra("flag",false) && getSupportFragmentManager().getBackStackEntryCount()==1){
            finish();
