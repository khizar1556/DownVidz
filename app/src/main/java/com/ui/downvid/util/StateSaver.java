...
public class StateSaver {
    ...
    /**
     * Try to restore the state from memory and disk, using the {@link WriteRead#readFrom(Queue)} from the writeRead.
     */
    @Nullable
    ...
    /**
     * If it's not changing configuration (i.e. rotating screen), try to write the state from {@link WriteRead#writeTo(Queue)}
