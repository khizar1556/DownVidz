package com.ui.downvid.database.subscription;
...
import static com.ui.downvid.database.subscription.SubscriptionEntity.SUBSCRIPTION_SERVICE_ID;
import static com.ui.downvid.database.subscription.SubscriptionEntity.SUBSCRIPTION_TABLE;
import static com.ui.downvid.database.subscription.SubscriptionEntity.SUBSCRIPTION_URL;

@Entity(tableName = SubscriptionEntity.SUBSCRIPTION_TABLE,
        indices = {@Index(value = {SubscriptionEntity.SUBSCRIPTION_SERVICE_ID, SubscriptionEntity.SUBSCRIPTION_URL}, unique = true)})
