package com.ui.downvid.database.stream.model;
...
import static com.ui.downvid.database.stream.model.StreamEntity.STREAM_SERVICE_ID;
import static com.ui.downvid.database.stream.model.StreamEntity.STREAM_TABLE;
import static com.ui.downvid.database.stream.model.StreamEntity.STREAM_URL;

@Entity(tableName = StreamEntity.STREAM_TABLE,
        indices = {@Index(value = {StreamEntity.STREAM_SERVICE_ID, StreamEntity.STREAM_URL}, unique = true)})
