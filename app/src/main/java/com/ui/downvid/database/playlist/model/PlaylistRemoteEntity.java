...
import com.ui.downvid.database.playlist.PlaylistLocalItem;
import org.schabi.newpipe.extractor.playlist.PlaylistInfo;
import com.ui.downvid.util.Constants;

import static com.ui.downvid.database.LocalItem.LocalItemType.PLAYLIST_REMOTE_ITEM;
import static com.ui.downvid.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_NAME;
import static com.ui.downvid.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_SERVICE_ID;
import static com.ui.downvid.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_TABLE;
import static com.ui.downvid.database.playlist.model.PlaylistRemoteEntity.REMOTE_PLAYLIST_URL;

@Entity(tableName = PlaylistRemoteEntity.REMOTE_PLAYLIST_TABLE,
        indices = {
                @Index(value = {PlaylistRemoteEntity.REMOTE_PLAYLIST_NAME}),
                @Index(value = {PlaylistRemoteEntity.REMOTE_PLAYLIST_SERVICE_ID, PlaylistRemoteEntity.REMOTE_PLAYLIST_URL}, unique = true)
        })
