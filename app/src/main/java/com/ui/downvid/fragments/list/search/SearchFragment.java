package com.ui.downvid.fragments.list.search;
...
import com.ui.downvid.fragments.list.BaseListFragment;
...
import com.ui.downvid.util.LayoutManagerSmoothScroller;
...
public class SearchFragment
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menuItemToFilterName.put(itemId, "videos");
      /*  MenuItem item = menu.add(1,
                itemId++,
                0,
                ServiceHelper.getTranslatedFilterString("videos", c));*/
       /* if(isFirstItem) {
