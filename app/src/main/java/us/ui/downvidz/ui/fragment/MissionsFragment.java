...
import us.ui.downvidz.ui.adapter.MissionAdapter;

public abstract class MissionsFragment extends Fragment {
    private DownloadManager mDownloadManager;
    private DownloadManagerService.DMBinder mBinder;
    private TextView showTxtvw;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        showTxtvw=(TextView)v.findViewById(R.id.showTxt);
        // Init
    ...
    private void updateList() {
        mAdapter = new MissionAdapter((Activity) mActivity, mBinder, mDownloadManager, mDeleteDownloadManager, mLinear, new MissionAdapter.CallBack() {
            @Override
            public void getList(List<DownloadMission> mItemList) {
                if(mItemList.size()!=0){
                    showTxtvw.setVisibility(View.GONE);
                }else{
                    showTxtvw.setVisibility(View.VISIBLE);
                }
            }
        });
