package us.ui.downvidz.ui.adapter;
...
import com.ui.downvid.download.DeleteDownloadManager;
...
import us.ui.downvidz.get.DownloadMission;
import us.ui.downvidz.service.DownloadManagerService;
import us.ui.downvidz.ui.common.ProgressDrawable;
import us.ui.downvidz.util.Utility;
...
public class MissionAdapter extends RecyclerView.Adapter<MissionAdapter.ViewHolder> {
    ...
    public MissionAdapter(Activity context, DownloadManagerService.DMBinder binder, DownloadManager downloadManager, DeleteDownloadManager deleteDownloadManager, boolean isLinear,CallBack callBack) {
        mContext = context;
    ...
    public interface CallBack{
        void getList(List<DownloadMission> mItemList);
    }
}
